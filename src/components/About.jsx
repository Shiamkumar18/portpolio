...
>
  ...
  <div
    ...
    bg-gradient-to-tr from-[#6d2897] via-[#6c95f5] to-[#bb61c5]
  ...
  <img
    ...
    rounded-2xl border border-white/10 shadow-lg hover:scale-105 transition-transform duration-300"
  />
  ...
  <img
    ...
    rounded-3xl shadow-2xl border border-white/10 hover:scale-105 transition-transform duration-300"
  />
  ...
  <img
    ...
    w-20 h-20 sm:w-28 sm:h-28 rounded-2xl border border-white/10 shadow-lg hover:scale-105 transition-transform duration-300"
  />
</figure>
        ...
        <article
          ...
          <div
            className='absolute z-0 w-40 h-40 sm:w-60 sm:h-60 bg-[#cd3cf5] rounded-full blur-3xl opacity-50 -top-5 left-10 ' ></div>
          <header>
            <h1
          ...
          <p className='text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8 landing-relaxed '>
            I’m Shivam Kumar, an engineering student with a strong passion for technology, creativity, and problem-solving. I enjoy building meaningful projects that blend design, logic, and innovation.
            I’m constantly learning new tools, improving my technical skills, and exploring ideas that push me to think differently. My goal is to create impactful digital solutions that make a real difference.
          </p>
          <footer>
